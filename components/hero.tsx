    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-zinc-500">AI Visibility · 2026</span>
        </motion.div>
        ...
        >
          We adopt your business to the new way people navigate the web. We make you trustworthy, and eligible for AI
          engines.
        </motion.p>
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-sm text-zinc-400">"Who is the best provider in [your industry]?"</span>
          </div>
          ...
          <div className="flex flex-col gap-3 mb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-zinc-700">Competitor A</span>
            </div>
            <div className="flex items-center gap-3">
              <Check className="w-4 h-4 text-emerald-500 shrink-0" strokeWidth={2} />
              <span className="text-sm text-zinc-700">Competitor B</span>
            </div>
            <div className="flex items-center gap-3">
              <X className="w-4 h-4 text-red-500 shrink-0" strokeWidth={2} />
              <span className="text-sm text-zinc-400 line-through">Your company</span>
            </div>
          </div>
