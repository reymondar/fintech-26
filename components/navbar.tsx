    ...
    >
      ...
      >
        ...
        <a href={localizeHref("/")} className="flex items-center gap-2">
          ...
          <span className="font-semibold text-zinc-900 hidden sm:block tracking-wide text-sm uppercase">{t("The Stack House")}</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-1 relative">
          ...
          <div className="relative group/tools">
            ...
            > {t("Herramientas")} <ChevronDown size={14} className="transition-transform duration-200 group-hover/tools:rotate-180 group-focus-within/tools:rotate-180" />
            </button>
            ...
            <div className="absolute left-1/2 top-full z-50 w-72 -translate-x-1/2 pt-3 invisible opacity-0 translate-y-1 pointer-events-none transition-all duration-150 group-hover/tools:visible group-hover/tools:opacity-100 group-hover/tools:translate-y-0 group-hover/tools:pointer-events-auto group-focus-within/tools:visible group-focus-within/tools:opacity-100 group-focus-within/tools:translate-y-0 group-focus-within/tools:pointer-events-auto">
              <div role="menu" className="rounded-2xl border border-zinc-200 bg-white p-2 shadow-xl">
                ...
                >
                  <span>
                    <span className="block text-sm font-semibold text-zinc-900">{t("UCP Checker")}</span>
                    <span className="mt-1 block text-xs leading-relaxed text-zinc-500"> {t("Comprueba si tu ecommerce está preparado para vender mediante agentes de IA.")} </span>
                  </span>
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <div className="mt-1 border-t border-zinc-100 pt-3">
              <p className="px-4 pb-1 text-[10px] font-semibold tracking-widest uppercase text-zinc-400">{t("Herramientas")}</p>
              <a
                href="https://ucp-checker.thestackhouse.io/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <span>
                  <span className="block font-medium">{t("UCP Checker")}</span>
                  <span className="mt-0.5 block text-xs text-zinc-400">{t("Audita tu preparación para comercio agéntico")}</span>
                </span>
